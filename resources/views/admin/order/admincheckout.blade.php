    ...
    <div class="col-md-8 mx-auto">
        ...
        <form action="{{url('admin/orders/admin_orders')}}" method="POST">
            ...
            <div class="card-radio mb-3">
                <div class="row">
                    <div class="col-md-6">
                        <input type="radio" class="form-switch" name="home_service" id="one" data-id="a" value="0"
                            checked>
                    ...
                    <div class="col-md-6">
                        <input type="radio" class="form-switch" name="home_service" data-id="b" id="two" value="1">
...
$('#car-dropdown').on('change', function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            $('#model-dropdown').html('<option value="">-- Pilih Mobil --</option>');
            $.each(result.usercars, function (key, value) {
                $("#model-dropdown").append('<option value="' + value.id + '">' + value.model + ' ' + value.varian + ' - ' + value.platnumber + ' (' + value.year +')</option>');
            });
        }
    });
});
