    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header bg-white d-flex justify-content-between align-items-start">
                <h4 class="my-auto">Province</h4>
                <a href="{{ url('admin/brands/create') }}" class="btn btn-success text-white">Add Province</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/provinces/city/' . $data->id) }}"
                                        class="btn btn-sm btn-primary text-white"><i class="fa fa-plus"></i> Tambah Kota
                                        {{-- @php $count = $countModels->where('brand_id', $data->id)->count() @endphp
                                        {{ $count }} --}}
                                    </a>
