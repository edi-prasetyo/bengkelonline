                ...
                <form action="{{url('admin/services/update-item/' .$serviceItem->id)}}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description"
                            class="form-control @error('a') is-invalid @enderror">{{$serviceItem->description}}</textarea>
                        @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="meta_description"
                            class="form-control @error('meta_description') is-invalid @enderror">{{$serviceItem->description}}</textarea>
